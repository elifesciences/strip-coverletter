...
# install sejda
RUN wget --quiet https://github.com/torakiki/sejda/releases/download/v3.2.85/sejda-console-3.2.85-bin.zip
RUN unzip -q sejda-console-3.2.85-bin.zip && ln -s sejda-console-3.2.85 sejda
